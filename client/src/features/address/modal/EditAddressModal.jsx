          ...
          <div className="overflow-y-auto p-5 space-y-6 scrollbar-hide">
            ...
            <div>
              ...
              <div className="bg-[#121212] border border-white/10 rounded-[24px] overflow-hidden divide-y divide-white/5">
                ...
                <div className="flex items-center px-4 py-1 h-14">
                  <span className="w-24 text-[15px] text-zinc-400">Alt Phone</span>
                  <input
                    type="tel"
                    inputMode="numeric"
                    maxLength={10}
                    value={formData.alternativePhone}
                    onChange={(e) => handleChange("alternativePhone", e.target.value.replace(/\D/g, ""))}
            ...
            <div className="pb-6">
              <label className="flex items-center justify-between p-4 bg-[#121212] border border-white/10 rounded-[20px] cursor-pointer">
                <div>
