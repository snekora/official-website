...
import { FolderPlus, Loader2, X, FolderCheck } from "lucide-react";

const ConfirmCreateCategoryModal = ({
  isOpen,
  onClose,
  onConfirm,
  categoryData,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400">
              Verify the category details before proceeding
            </p>
          </div>
        </div>
        ...
        <p className="text-xs text-zinc-400">
          Are you sure you want to create this product category with the specified details?
        </p>
...
export default ConfirmCreateCategoryModal;
