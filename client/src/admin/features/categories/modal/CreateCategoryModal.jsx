...
import { FolderPlus, Loader2, X, FolderOpen } from "lucide-react";

const CreateCategoryModal = ({ isOpen, onClose, onSubmit, isSubmitting }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-2 block text-xs uppercase tracking-wider text-zinc-400 font-semibold">
              Category Name *
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-[#0c0c0d] py-3 pl-10 pr-4 text-sm text-white outline-none placeholder:text-zinc-600 focus:border-lime-400/50"
              />
            </div>
          </div>
