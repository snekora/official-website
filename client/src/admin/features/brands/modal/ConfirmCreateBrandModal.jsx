  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400">
              Verify the brand details before proceeding
            </p>
          </div>
        </div>
              ...
              <div className="flex items-center gap-3">
                {brandData.logoPreview && (
                  <img
                    ...
                    alt="Preview"
                    className="h-12 w-12 rounded-xl object-contain bg-white/5 border border-white/10 p-1 shrink-0"
                  />
                )}
                <span className="text-xs font-mono text-zinc-300 break-all truncate">
                  {brandData.logo instanceof File
                    ? brandData.logo.name
                    : typeof brandData.logo === "string"
                    ? brandData.logo
                    : brandData.logo?.url}
                </span>
              </div>
        ...
        <p className="text-xs text-zinc-400">
          Are you sure you want to create this product brand with the specified details?
        </p>
...
export default ConfirmCreateBrandModal;
